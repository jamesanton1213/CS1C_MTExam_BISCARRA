...
while (running) {
    ...
    if (choice === "A") {
        // Enroll a student
        let studentName = prompt("Insert the student's name:");
        let subject = prompt("Insert the subject (DSA or WebDev):").toUpperCase();
        ...
        if (subject === "DSA") {
            ...
            if (WebDev.length > 0) {
                ...
                let studentToRemove = prompt("Insert the name of the student to remove:");
